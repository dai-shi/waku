    ...
    <>
      <div className="fixed right-0 top-0 z-100 p-5 xl:hidden">
        <button
          ...
          className={cx(
            'group relative inline-flex aspect-square h-14 w-14 items-center justify-center overflow-clip rounded-full border-4 border-gray-950 text-3xl transition-opacity duration-300 ease-in-out focus:ring-4 focus:ring-primary-300 lg:focus:ring-0',
          )}
        >
