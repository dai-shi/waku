...
Note that a new `pages.gen.ts` file is present in your project. Check this file into your code repository for compile-time type checking in your CI/CD pipeline. It should also be ignored by your formatter and linter (e.g. adding `pages.gen.ts` to `.prettierignore`).
