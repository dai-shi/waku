...
import { parseOpts, transformServerActionsOpts } from '../utils/swc.js';
...
`;
    ...
    const output = swc.transformSync(code, transformServerActionsOpts(ext))
    return output.code.replaceAll('swc-plugin-react-server', 'waku')
  }
};
