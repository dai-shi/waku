...
export function Stock({ name = 'DOGE', price = 12.34, delta = 1 }) {
  ...
  return (
    <div className="text-green-400 bg-zinc-950 rounded-xl border p-4">
      ...
      <div className="text text-zinc-500 mt-1 text-xs">
      ...
      >
        {priceAtTime.x > 0 ? (
          <div
            className="bg-zinc-800 pointer-events-none absolute z-10 flex w-fit select-none gap-2 rounded-md p-2"
            style={{
        ...
        {startHighlight ? (
          <div
            className="bg-zinc-500/20 border-zinc-500 pointer-events-none absolute h-32 w-5 select-none rounded-md border"
            style={{
              left: startHighlight,
              width: endHighlight
