  ...
  return (
    <>
      ...
      <article className="mt-6">
        <div className="my-3">
          Wakuwork is a React framework that supports React Server Components
        ...
        <div className="my-3">
          Wakuwork takes a minimalistic approach, providing a minimal API that
        ...
        <div className="my-3">
          Wakuwork uses Vite internally, and while it is still a work in
          progress, it will eventually support all of Vite's features. It can
          even work as a replacement for Vite + React client components. While
          using RSCs is optional, it is highly recommended for improved user and
